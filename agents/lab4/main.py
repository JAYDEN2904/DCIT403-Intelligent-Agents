...
async def main():
    ...
    print("\n📦 Package Structure:")
    print("   agents/lab4/")
    print("   ├── utils.py              (Performatives, MessageLogger)")
    print("   ├── sensor_agent.py       (CommunicatingSensorAgent)")
    print("   ├── coordinator_agent.py  (CoordinatorAgent)")
    print("   ├── rescue_agent.py       (CommunicatingRescueAgent)")
